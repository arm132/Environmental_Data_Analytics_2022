...
#axis text refers to numbers on axes (not axes labels)
#legend justification means right, left, or center alignment
...
#lty specifies type of line 
#hline means horizontal line 
#alpha means transparency of lines 
#hjust is the horixontal justification, 1 means left aligning 
#when setting limits must specifiy a range 
```
...
#rel_heights=relative heights, if one plot needs more space than the other
```
