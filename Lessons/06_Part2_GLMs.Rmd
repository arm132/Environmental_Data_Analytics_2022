...
Research question of the day: Does total litter biomass differ among sites at the Niwot Ridge LTER?
```{r}
# Wrangle the data
...
# Format ANOVA as aov (data, continuous/dependent ~ categorical/independent)
