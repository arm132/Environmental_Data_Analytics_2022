...
#expression command allows us to include formatted characters intro script, greek letters are included, also degree (get the little sign)
#paste allows you to take multiple strings separated by commas and put them together
#^{} makes super script, [] is subscript
...
temp_by_date<-ggplot(PeterPaul.chem.nutrients)+
