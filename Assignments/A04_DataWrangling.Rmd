...
dim(processed_all_Air_data)

#11

write.csv(processed_all_Air_data, row.names=FALSE, file="/Users/rorymccollum/Desktop/Rdata/Environmental_Data_Analytics_2022/Data/Processed/EPAair_O3_PM25_NC2122_Processed.csv")
...
```{r}
#12(a,b)
#copied from above, don't need to run again 
Air.summary<-
  STEP NINE %>%
 

  #use cominbation of filter fxn and is.na figure out if and/or statement 
